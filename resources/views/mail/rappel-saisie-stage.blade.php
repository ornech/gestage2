...
<div class="container">
    ...
    <div class="header">
        <h1>Rappel — Saisie de votre stage</h1>
    </div>
    ...
    <div class="body">
        ...
        <p>
            Nous n'avons pas encore enregistré les informations de votre stage dans l'application
            <strong>{{ config('app.name') }}</strong>.
        </p>

        <p>
            Pour que votre tuteur puisse vous suivre et que votre convention soit traitée,
            merci de renseigner les informations de votre stage dès que possible :
            nom de l'entreprise, dates, maître de stage, etc.
        </p>
    ...
    <div class="footer">
        ...
        Ce message est envoyé automatiquement. Si votre stage est déjà saisi, ignorez ce message.
    </div>
